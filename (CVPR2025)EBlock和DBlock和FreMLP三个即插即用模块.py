...
if __name__ == '__main__':
    ...
    output =  EBlock(input)
    print('Ai缝合即插即用模块永久更新-EBlock input_size:', input.size())
    print('Ai缝合即插即用模块永久更新-EBlock output_size:', output.size())

    output = DBlock(input)
    print('Ai缝合即插即用模块永久更新-DBlock input_size:', input.size())
    print('Ai缝合即插即用模块永久更新-DBlock output_size:', output.size())

    output = FreMLP(input)
    print('Ai缝合即插即用模块永久更新-FreMLP input_size:', input.size())
    print('Ai缝合即插即用模块永久更新-FreMLP output_size:', output.size())
